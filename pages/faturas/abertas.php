            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
					...
					$SQLUPUser= "SELECT * FROM fatura where usuario_id =  '".$usuario['id_usuario']."' and status='pendente' ORDER BY id desc ";
                  ...
                  <tr >
				   ...
				   <td>
					   ...
					   <a href="home.php?page=faturas/verfatura&id=<?php echo $row['id'];?>" class="btn btn-block btn-success btn-sm">Visualizar</a>
