...
<script>
  ...
  $('#example1').DataTable({
    "language": {
        ...
        "sEmptyTable":    "Nenhum chamado ENCERRADO atualmente de seus clientes",
...
<!-- Main content -->
 ...
 <div class="row">
   ...
   <?php
                    ...
                    $SQLUsuario = "SELECT * FROM chamados   where  status = 'encerrado' and id_mestre='".$_SESSION['usuarioID']."' ORDER BY id desc";
	...
	<div class="modal-content">
		...
		<div class="modal-footer">
			<div class="btn-group btn-group-justified" role="group" aria-label="group button">
				...
				<div class="btn-group" role="group">
					<button class="btn btn-default btn-hover-green">Deletar Chamado</button>
					</form>
				</div>
			</div>
		</div>
