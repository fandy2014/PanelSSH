...
<section class="content-header">
      <h1>
        Faturas
        <small>Lista de faturas canceladas</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-header">
              <h3 class="box-title">Verifique suas faturas canceladas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
					...
					$SQLUPUser= "SELECT * FROM fatura_clientes where usuario_id =  '".$usuario['id_usuario']."' and status='cancelado' ORDER BY id desc ";
