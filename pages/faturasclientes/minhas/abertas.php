...
<section class="content-header">
      <h1>
        Faturas
        <small>Lista de faturas a pagar</small>
      </h1>
      <ol class="breadcrumb">
         <li><a href="home.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
         <li class="active">Faturas</li>
        <li class="active">Abertas</li>
      </ol>
       </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-header">
              <h3 class="box-title">Verifique os dados das suas faturas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
					...
					$SQLUPUser= "SELECT * FROM fatura_clientes where usuario_id =  '".$usuario['id_usuario']."' and status='pendente' ORDER BY id desc ";
                  ...
                  <tr >
				   ...
				   <td>
					   ...
					   <a href="home.php?page=faturasclientes/minhas/verfatura&id=<?php echo $row['id'];?>" class="btn btn-block btn-success btn-sm">Visualizar</a>
