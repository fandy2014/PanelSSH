...
$SQLUPUser= "SELECT * FROM fatura_clientes where id='".$fatura_id."'";
...
$SQLmp = "select * from usuario where id_usuario='".$fatu['id_mestre']."'";
...
if($mp1['idcliente_mp']==''){        echo '<script type="text/javascript">';
		echo 	'alert("O Seu Patrão não configurou o MercadoPago Abra um chamado!");';
		echo	'window.location="home.php?page=faturasclientes/minhas/abertas";';
		echo '</script>';
		exit;
}

if($mp1['tokensecret_mp']==''){ echo '<script type="text/javascript">';
		echo 	'alert("O Seu Patrão não configurou o MercadoPago Abra um chamado!");';
		echo	'window.location="home.php?page=faturasclientes/minhas/abertas";';
		echo '</script>';
		exit;
...
$mp = new MP ("".$mp1['idcliente_mp']."", "".$mp1['tokensecret_mp']."");
...
// busca empresa
$buscaempresa= "SELECT * FROM smtp_usuarios where usuario_id='".$mp1['id_usuario']."'";
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            Telefone: <?php echo $mp1['celular'];?><br>
            Email: <?php echo $mp1['email'];?>
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
